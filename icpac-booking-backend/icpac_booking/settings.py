...
# Channel Layers (WebSocket) - fallback to in-memory for development
CHANNEL_LAYERS = {
    'default': {
...
# Wagtail settings
WAGTAIL_SITE_NAME = 'ICPAC Booking System'
WAGTAILADMIN_BASE_URL = config('WAGTAILADMIN_BASE_URL', default='http://localhost:8001')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@icpac.net')
